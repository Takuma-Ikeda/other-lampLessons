        ...
        <div>
            <form action="form_quiz_template_thanks.php" method="post">
                ...
                <div>
                    ...
                    <div>
                        <label>性別</label>
                        <p><?php if ($user_request->getSexId() == '1') echo '男性' ?></p>
                        <p><?php if ($user_request->getSexId() == '2') echo '女性' ?></p>
                        <p><?php if ($user_request->getSexId() == '3') echo '未回答' ?></p>
                    </div>
                    <div>
                        <label>お問い合わせ項目</label>
                        <p><?php if ($user_request->getItemId() == '1') echo 'ご質問・お問い合わせ' ?></p>
                        <p><?php if ($user_request->getItemId() == '2') echo 'ご意見・ご感想' ?></p>
                    </div>
                    <div>
